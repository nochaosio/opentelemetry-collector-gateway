...
// Program otelcol-gateway is an OpenTelemetry Collector binary.
package main
...
func main() {
	info := component.BuildInfo{
		Command:     "otelcol-gateway",
		Description: "High-performance edge collector for managing telemetry data",
		Version:     "0.1.0",
	}
